...
void Window::Start()
{
	...
	// Our desired timestep - 30 frames a second.
	...
	while(running)
	{
		//If we have a message to process, store it in msg and remove it from the message queue
		...
		else
		{
			...
			// Do this by looping fixed time increments (1/30) and passing this for update.
			...
			// To prove this works, install FRAPS and you'll see a yellow FPS label overlayed in the corner of our game
